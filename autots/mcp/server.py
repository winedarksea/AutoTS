...
if MCP_AVAILABLE:
    ...
    async def call_tool(name: str, arguments: Any) -> list[TextContent]:
        ...
        try:
            if name == "get_sample_data":
                ...
                result = dataframe_to_json(forecast_df, data_format="wide")
    ...
    async def list_resources() -> list[Any]:
        ...
        doc_files = [
            ("extended_tutorial.md", "Extended AutoTS Tutorial"),
            ("production_example.py", "Production Example Script"),
            ("README.md", "AutoTS README"),
            ("docs/metric_weighting_guide.md", "Metric Weighting Guide"),
            ("docs/catlin_m6_paper.tex", "M6 Forecasting Competition Paper (LaTeX)"),
        ]
