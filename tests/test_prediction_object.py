...
class TestPredictionObject(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.forecast_index = pd.date_range('2024-01-01', periods=self.forecast_length, freq='D')
    ...
    def test_copy_memory_independence(self):
        ...
        self.assertIsNot(original.transformation_parameters, copy_obj.transformation_parameters)
    ...
    def test_copy_modification_independence(self):
        ...
        self.assertEqual(original.model_parameters['nested']['param2'], original_nested_value)
        ...
        self.assertEqual(copy_obj.model_parameters['nested']['param2'], 'modified_nested')
    ...
    def test_copy_with_components(self):
        ...
        components_data = pd.DataFrame(
            ...
            index=self.forecast_index,
            columns=pd.MultiIndex.from_product([self.forecast_columns, ['trend', 'seasonal']])
        )
    ...
    def test_copy_with_metrics(self):
        ...
        self.assertTrue(np.array_equal(original.full_mae_error, copy_obj.full_mae_error))
