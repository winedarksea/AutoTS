...
class TestCointegration(unittest.TestCase):
    ...
    def test_coint_johansen_with_eigenvalues(self):
        ...
        eigenvals, eigenvecs = coint_johansen(self.data, fast=True, return_eigenvalues=True)
    ...
    def test_coint_johansen_slow_with_eigenvalues(self):
        ...
        eigenvals, eigenvecs = coint_johansen(self.data, fast=False, return_eigenvalues=True)
    ...
    def test_btcd_decompose_with_eigenvalues(self):
        ...
        model = LinearRegression()
        eigenvals, eigenvecs = btcd_decompose(self.data, model, max_lag=1, return_eigenvalues=True)
