...
class TestMetrics(unittest.TestCase):
    ...
    def test_metrics(self):
        ...
        known_avg_metrics = pd.Series(
            [
                40., 2., 3.162, 0.533, 4.000, 0, 0, -3.333, 0.1240, 3.333, 0.1240, 
        ...
        known_avg_metrics_weighted = pd.Series(
            [
                6.667, 0.333, 0.527, 0.089, 4.000, 0, 0, -0.833, 0.021, 0.833, 0.021,
        ...
        b_avg_metrics = pd.Series(
            [
                80., 4., 6.325, 1.067, 4.000, 0, 0, -10.0, 0.2480, 10.0, 0.2480, 0.44,
